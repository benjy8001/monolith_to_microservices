...
composer init --name benjy8001/microservices-common --description "This is a package for the Microservices testing" --author "Benjamin Mabille <benjy80@gmail.com>" --type library --license MIT --require "laravel/framework:^7.*"
```
